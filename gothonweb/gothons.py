import random
from gothonweb.game import Game, Room
...
the code wrong then the lock closes forever and you can't get the bomb.
...
TITLE = "Gothons from Planet Percal #25"
...
def newgame():
    return Game(START, TITLE, INSTRUCTIONS)